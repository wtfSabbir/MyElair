...
class MinkUNetBase(ResNetBase):
    ...
    def network_initialization(
        ...
        self.conv0p1s1 = ME.MinkowskiConvolution(
            in_channels, self.inplanes, kernel_size=2, dimension=D,kernel_generator=ME.KernelGenerator(
        kernel_size=3,
        stride=1,
        dilation=2,  # ou 1 selon la profondeur
        region_type=ME.RegionType.HYPER_CROSS,  # ou HYPERCUBE
        dimension=3
    )
        )
