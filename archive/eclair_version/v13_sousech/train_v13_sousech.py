...
from eclair_version.v13_sousech.utils_v13_sousech import (
    FocalLoss,
    FocalTverskyLoss,
    seed_everything,
    TrainDataset,
...
from eclair_version.v13_sousech.model_v13_plo_sousech import MinkUNet14C, Binary_model, MinkUNet101, MinkUNet50, MinkUNet34A, MinkUNet14, MinkUNet18, MinkUNet18B
...
def make_data(conf) -> PyGDataLoader:
    ...
    """
    label_file = "/home/mtardif/src/MinkowskiEngine/data/labels_v13_horssol.json"
    # label_file = "/mnt/d/pointcloud_data/iantsa/reanno_16c/gt/labels_iantsa16c.json"
    with open(label_file, encoding="utf-8") as f:
        all_tiles: List[Dict] = json.load(f)

    train_tiles = [
        "/home/mtardif/src/MinkowskiEngine/data/pointclouds_horssol" + "/" + x["tile_name"]
...
def main() -> None:
    ...
    base_conf = OmegaConf.load("/home/mtardif/src/MinkowskiEngine/eclair_version/v13_sousech/plo_cross.yaml")
    ...
    # checkpoint_path = "/mnt/d/pointcloud_data/trainingset_eclair/photo_verticaux/weights/firstmodelall_trainv13_attcoordsnew_214clouds_minkunet14c_6c_normrange_vxl007_404040range_FTL_adapt_b2_bestvallossweights.pth"
    checkpoint_path = ""
