...
def make_data(conf) -> PyGDataLoader:
    ...
    """
    # label_file = "/mnt/d/pointcloud_data/trainingset_eclair/photo_verticaux/all_set_v5/labels_vert_v5.json"
    label_file = "/mnt/d/pointcloud_data/trainingset_eclair/photo_verticaux/all_set_v10/potelet/labels_v10_potelet.json"
    with open(label_file, encoding="utf-8") as f:
        all_tiles: List[Dict] = json.load(f)

    train_tiles = [
        "/mnt/d/pointcloud_data/trainingset_eclair/photo_verticaux/all_set_v10/potelet/pointclouds" + "/" + x["tile_name"]
        for x in all_tiles
        if x["split"] == "train"
    ]
